...
<!--    头部区域-->
    <el-header>
      ...
      <div class="headtext">智能井盖管理系统</div>
...
<!--          一级菜单-->
          ...
          <el-menu-item index="/list" @click="savePath('list')">
            <i class="el-icon-dish"></i>
            <span slot="title">井盖管理</span>
          </el-menu-item>


            <el-menu-item index="/warn" @click="savePath('warn')">
              <i class="el-icon-bell"></i>
              <span slot="title">预警信息</span>
            </el-menu-item>


          <el-menu-item index="/setting" @click="savePath('setting')">
            <i class="el-icon-setting"></i>
            <span slot="title">参数配置</span>
          </el-menu-item>

          <el-menu-item index="/log" @click="savePath('log')">
